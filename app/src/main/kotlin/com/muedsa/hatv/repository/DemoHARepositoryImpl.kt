...
class DemoHARepositoryImpl : IHARepository {
    ...
    private fun getDemoVideos(): List<VideoInfoModel> {
        val rand = Random()
        return listOf(
            VideoInfoModel(
                rand.nextInt(99999).toString(),
                "https://i0.hdslb.com/bfs/archive/ed2cba8037673df23714b625bb5316a9c6cfa2de.jpg",
            ...
            VideoInfoModel(
                rand.nextInt(99999).toString(),
                "https://i2.hdslb.com/bfs/archive/3f6ce09fdb6dcca5d77b19a517c840d6626a5128.jpg",
                "汽车安全锤",
                "鉴货兄弟",
            ...
            VideoInfoModel(
                rand.nextInt(99999).toString(),
                "https://i1.hdslb.com/bfs/archive/3f80e62fd5e026eb9fba85cf435200697afe43cc.jpg",
            ...
            VideoInfoModel(
                rand.nextInt(99999).toString(),
                "https://i2.hdslb.com/bfs/archive/884e98a234d684d0dd1072d8863362feda6b6a84.jpg",
            ...
            VideoInfoModel(
                rand.nextInt(99999).toString(),
                "https://i2.hdslb.com/bfs/archive/5e3581d4e5c909fd5bb3b3266d88f7012bbc06f0.jpg",
                "《明日方舟》EP - Miss You",
                "明日方舟",
            ...
            VideoInfoModel(
                rand.nextInt(99999).toString(),
                "https://i1.hdslb.com/bfs/archive/50e182cc93ff8214cf9b50675bff5e6fb922a57c.jpg",
                "“他就想活命，他有什么罪!”",
                "听云up",
                "电影:我不是药神\nBGM:用什么把你留住"
            ),
            VideoInfoModel(
                rand.nextInt(99999).toString(),
                "https://i0.hdslb.com/bfs/archive/bb84784e48d4fa283a772e4b755134181949e961.jpg",
                "网络热门生物鉴定49",
                "无穷小亮的科普日常",
                ""
            ),
